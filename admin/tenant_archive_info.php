...
?>
    ...
    <body>
        <div class="container">
            ...
            <a href="tenant_archive.php" class="btn-sm btn btn-outline-secondary">Back</a>
            ...
            <button title="Reactivate tenant account" type='button' name="reactivate" data-bs-toggle="modal" data-bs-target="#modalReactivate" class='btn-sm btn btn-outline-success'>Reactivate</button>

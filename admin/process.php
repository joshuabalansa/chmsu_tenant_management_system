 <?php
    ...
    if (isset($_GET["editInfo"])) {
        ...
        users.user_id, coordinators.first_name, coordinators.middle_name, coordinators.last_name FROM users JOIN coordinators ON coordinators.user_id = users.user_id WHERE users.id = $id");

                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href='mail/accept.php?accept=<?php echo $row['id'] ?>' name='btnAccept' class='btn-sm btn btn-success' title="Accept tenant with complete requirements">Accept</a>
                                    <a href="mail/incomplete.php?incomplete=<?php echo $row['id'] ?>" name='btnReject' class='btn-sm btn btn-warning' title="Accept tenant with incomplete requirements">Reject</a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
